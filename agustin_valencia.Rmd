...
```{r q1_devtree_optimal_depth, echo=FALSE, warning=FALSE, out.height='40%', fig.align='center'}
...
```{r q1_roc_curves, echo=FALSE, warning=FALSE, out.height='40%', fig.align='center'}
...
### 6. Repeat Naïve Bayes classification as it was in step 4 but use the following loss matrix.  and report the confusion matrix for the training and test data. Compare the results with the resukts from step 4 and discuss how the rates have changed and why.
