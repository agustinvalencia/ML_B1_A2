...
ggplot() + geom_point(aes(x=1:length(prop), y=prop)) + 
    ylab("Explained Variance [%]") + xlab("Component") + 
    ggtitle("Principal Components Contribution")
...
ggplot() + geom_line(aes(x=x, y=res$rotation[,1])) +
    ggtitle("Traceplot PC1") + ylab("U") + xlab("Index")
ggplot() + geom_line(aes(x=x, y=res$rotation[,2])) +
    ggtitle("Traceplots PC2") + ylab("U") + xlab("Index")
```
